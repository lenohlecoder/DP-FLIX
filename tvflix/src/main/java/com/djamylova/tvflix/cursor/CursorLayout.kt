...
class CursorLayout @JvmOverloads constructor(
    ...
    init {
        ...
        // Le WebView possède déjà son pipeline matériel. Ne pas imposer un layer
        // au parent entier : cela peut forcer une recomposition coûteuse de la page
        // + de l'overlay curseur sur les box modestes.
        isFocusable = true

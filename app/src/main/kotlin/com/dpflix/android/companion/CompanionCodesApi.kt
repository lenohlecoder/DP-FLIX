...
class CompanionCodesApi(
    ...
    suspend fun redeemCode(code: String, sessionId: String? = null, installationId: String? = null): RedeemCodeResponse =
    ...
    suspend fun codeStatus(code: String, sessionId: String? = null, installationId: String? = null): CodeStatusResponse = withContext(Dispatchers.IO) {
